package br.com.mbc.cursos.CursoJUnitM2.utils;
...
public class DateUtils {
	...
	public static Date addDaysFromToday(int dias) {
	 ...
	 * @return
	 */
	public static boolean verifyDayOfTheWeek(Date data, int diaSemana) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(data);
